...
interface AnimationNode {
  ...
  values: Animated.AnimatedInterpolation<any>[];
}

export interface Props<T extends string> {
  initAnimation: () => Record<T, (value: Animated.Value) => AnimationNode>;
  children: (
    interpolationsByKey: Record<T, Animated.AnimatedInterpolation<any>[]>,
  ) => React.ReactNode;
  animating: boolean;
}
...
> extends React.Component<Props<T>> {
  ...
  >;
  interpolationsByKey: Record<T, Animated.AnimatedInterpolation<any>[]> =
    {} as Record<T, Animated.AnimatedInterpolation<any>[]>;
